...
<!--
  Entries above the 0.3.0 heading are generated by changesets from the files in .changeset/.
  Entries from 0.3.0 down were written by hand in Keep a Changelog format. Both follow semver.
  Do not edit this file directly — run `pnpm changeset` instead.
  See docs/how-to.md#release-a-new-version.
-->
