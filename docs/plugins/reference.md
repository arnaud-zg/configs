...
| `metadata.version`                    | string           | Marketplace version. Optional, and unused here: nothing updates it, so a hand-written value goes stale. This repository omits it and versions plugins individually instead.                               |
