...
| 🔗 Integration | `internal/resolve-installed-package.integration.test.ts` | The one real filesystem lookup, including the remark-cli `exports: []` fallback, plus a coarse performance regression guard |
